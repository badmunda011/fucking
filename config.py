...
BOT_TOKEN15 = config("BOT_TOKEN2", default=None)
BOT_TOKEN14 = config("BOT_TOKEN3", default=None)
BOT_TOKEN13 = config("BOT_TOKEN4", default=None)
BOT_TOKEN512 = config("BOT_TOKEN5", default=None)
BOT_TOKEN11 = config("BOT_TOKEN6", default=None)
BOT_TOKEN10 = config("BOT_TOKEN7", default=None)
BOT_TOKEN9 = config("BOT_TOKEN8", default=None)
BOT_TOKEN8 = config("BOT_TOKEN9", default=None)
BOT_TOKEN7 = config("BOT_TOKEN10", default=None)
BOT_TOKEN6 = config("BOT_TOKEN", default=None)
BOT_TOKEN5 = config("BOT_TOKEN2", default=None)
BOT_TOKEN4 = config("BOT_TOKEN3", default=None)
BOT_TOKEN3 = config("BOT_TOKEN4", default=None)
BOT_TOKEN2 = config("BOT_TOKEN5", default=None)
